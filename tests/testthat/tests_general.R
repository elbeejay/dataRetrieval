...
test_that("General NWIS retrievals working", {
  ...
  recent_uv <- readNWISdata(
    siteNumber = "04025500", parameterCd = "00060", service = "uv",
  ...
  dailyStat <- readNWISdata(
    site = c("03112500", "03111520", "02319394"), service = "stat", statReportType = "daily",
  ...
  waterYearStat <- readNWISdata(
    site = c("01646500"), service = "stat", statReportType = "annual",
